/* ============================================================
   AI Judgment Micro-Intervention Pilot — Networked Participant Client
...
function formatDisplayItemId(id) {
  ...
  const match = /^(PRE|POST)_([A-Z]\d+)$/.exec(id);
...
function computeProfile() {
  ...
  return { method: "auto-score: judgment + action", categorySummaries: summaries, profiles };
}
