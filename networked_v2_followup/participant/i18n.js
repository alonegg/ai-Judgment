(function () {
  ...
  const T = LANG === "en" ? {
    doc_title: "AI Judgment Micro-Intervention Lean-30",
    header_eyebrow: "",
    header_title: "AI Judgment Micro-Intervention Lean-30",
    ...
    consent_pills: ["Consent", "Warm-up", "Pretest x4", "Profiling", "Intervention x2", "Posttest x4", "Interview", "End"],
    consent_duration: "Estimated duration: <strong>24-30 minutes</strong>",
    ...
    reason_placeholder: "Explain your judgment in one sentence.",
    ...
    interview_title: "Short Interview (3-4 min)",
    interview_tag: "Interview",
    interview_intro: "Please answer three short questions orally. The operator will record your key points on their device.",
    interview_questions: [
      "When would you choose Reject?",
      "When would you choose Revise instead of Reject?",
      "Which scene helped you understand the boundary best, and why?"
    ],
    interview_ref_title: "Reference Questions",
    interview_ref_help: "These are the three fixed interview prompts. The operator will guide you through them one by one.",
    ...
    doc_title: "AI 判断力微干预实验 Lean-30",
    header_eyebrow: "",
    header_title: "AI 判断力微干预 Lean-30",
    conn_connecting: "连接中...",
    conn_connected: "已连接",
    ...
    consent_pills: ["同意书", "热身", "前测 ×4", "个性化诊断", "干预练习 ×2", "后测 ×4", "访谈", "结束"],
    consent_duration: "总时长约 <strong>24-30 分钟</strong>",
    ...
    warmup_steps: ["做出判断（接受 / 修改 / 拒绝 或 选择 A / 选择 B）", "写 1 句理由", "选择下一步动作", "打 1-5 的信心分"],
    ...
    reason_placeholder: "用 1 句话说明你为什么这样判断。",
    ...
    interview_title: "短访谈（3-4 分钟）",
    interview_tag: "访谈",
    interview_intro: "请口头回答实验员的问题。实验员会在操作台记录你的回答要点。",
    interview_questions: ["什么时候你会选择“拒绝”？", "什么时候你会选择“修改”而不是“拒绝”？", "哪个场景最帮助你理解边界？为什么？"],
    interview_ref_title: "参考问题",
    interview_ref_help: "以下是固定的 3 个访谈问题，实验员会引导你逐一回答。",
