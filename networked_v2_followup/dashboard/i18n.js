(function () {
  ...
  const T = LANG === "en" ? {
    doc_title: "Operator Dashboard — AI Judgment Lean-30",
    header_title: "Operator Dashboard",
    header_subtitle: "AI Judgment Micro-Intervention Follow-up Lean-30",
    ...
    interview_help: "Please record the participant's spoken answers to the three fixed prompts here.",
    interview_questions: [
      "When would the participant choose Reject?",
      "When would the participant choose Revise instead of Reject?",
      "Which scene helped the participant understand the boundary best, and why?"
    ],
    ...
    doc_title: "操作台 — AI 判断力微干预实验 Lean-30",
    header_title: "操作台",
    header_subtitle: "AI 判断力微干预实验 Lean-30",
    conn_connected: "● 已连接",
    ...
    interview_help: "请在此记录参与者对 3 个固定访谈问题的口头回答。",
    interview_questions: [
      "参与者什么时候会选择“拒绝”？",
      "参与者什么时候会选择“修改”而不是“拒绝”？",
      "哪个场景最帮助参与者理解边界？为什么？"
    ],
