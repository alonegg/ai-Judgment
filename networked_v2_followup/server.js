/* ============================================================
   AI Judgment Micro-Intervention Follow-up Lean-30 — Networked Server
...
const DATA_DIR = path.join(__dirname, "data_lean30");
const MATERIAL_CANDIDATES = {
  zh: [
    path.join(__dirname, "..", "materials_v2_followup.json")
  ]
  ,
  en: []
};
